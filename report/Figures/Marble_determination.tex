	...
	\begin{subfigure}[b]{0.49\textwidth}
  	...
  	\begin{subfigure}[b]{0.49\textwidth}
		...
		\begin{tikzpicture}
			...
			\draw [white] (3.5, 0);
		\end{tikzpicture}
		\caption{Illustration of circle chord and arch heigh can be found from the LIDAR data and thereby can determine the circle's radius and the chord angle}
		\label{fig:lidar_marble_scaled}
  	\end{subfigure}
  	\caption{Illustration of determination of circle radius from LIDAR data}
