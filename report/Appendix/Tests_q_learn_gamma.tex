...
This test was done by performing 100 trials of each selected value of $\gamma$ for a range of episodes. The test was conducted using the world "5-room world" seen on figure \ref{fig:5_room_world_2}.\\
...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.49\textwidth}
		\centering
		\includegraphics[width=\textwidth]{q_learning_5_rooms_test_gamma_average_reward}
	...
	\begin{subfigure}[b]{0.49\textwidth}
		\centering
		\includegraphics[width=\textwidth]{q_learning_5_rooms_test_gamma_average_iterations}
