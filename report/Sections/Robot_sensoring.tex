...
%This section describes the processing of data from both the camera and the lidar sensor. It describes the process of finding the marbles in the picture from the camera, the detected walls (obstacles) in the area of the lidar sensor and the entrances to the individual rooms from the camera and the lidar sensor. \\
%The aim of this section is to {\color{red} bla. bla. bla.} 
