...
The world \textit{"bigworld"} has been divided into several small rooms.

\begin{figure}[H]
	\centering
	\begin{tikzpicture}
		\node[anchor=south west, inner sep=0] (image) at (0,0) {\includegraphics[width=0.75\textwidth]{map_medium}};
	...
	\end{tikzpicture}
	\caption{Bigworld divided into rooms}
\end{figure}
